...
define(c_base, x9)									// register for holding base of struct c
...
newCuboid:	stp	x29, x30, [sp, alloc2]!						// increment sp, then store fp and lr
		...
		add	c_base, x29, c_s						// set base address of c
		
		// set origin.x, origin.y of c
		mov	w10, 0								// w10 = 0
		str	w10, [c_base, cuboid_origin + point_x]				// c.origin.x = 0
		str	w10, [c_base, cuboid_origin + point_y]				// c.origin.y = 0
		
		// set base.width, base.length of c
		mov	w11, 2
		str	w11, [c_base, cuboid_base + dimension_width]			// c.base.width = 2
		str	w11, [c_base, cuboid_base + dimension_length]			// c.base.length = 2
		
		// set height of c
		mov	w12, 3								// w12 = 3
		str	w12, [c_base, cuboid_height]					// c.height = 3
		
		// calculate volume
		mul	w13, w11, w11							// w13 = c.base.width * c.base.length
		mul	w13, w13, w12							// w13 = w13 * c.height
		str	w13, [c_base, cuboid_volume]					// c.volume = c.base.width * c.base.length * c.height
